...
def countingByDataset(files, output): 
    # %%
    ...
    infile = file_jsonl
    outfile = output + "\CountingByDataset_" + date + ".csv"
    
    views_infile = output + '\json_merged.csv'
    ...
    adminCounterColumnDivision.to_csv(output + '\scienceAdminDivision_' + date + '.csv', encoding = 'utf-8')
    ...
    adminCounterColumnDirectorate.to_csv(output + '\scienceAdminDirectorate_' + date + '.csv', encoding = 'utf-8')
    ...
    pCounterColumn.to_csv(output + '\datasetProjectCount' + date + '.csv', encoding = 'utf-8')
    ...
    divCounterColumn.to_csv(output + '\datasetDivisionCount' + date + '.csv', encoding = 'utf-8')
    ...
    dirCounterColumn.to_csv(output + '\datasetDirectorateCount' + date + '.csv', encoding = 'utf-8')
    ...
    low_views.to_csv(output + '\datasetViews_' + date + '.csv', encoding = 'utf-8')
    ...
    high_views_graph = output + "\datasetViews_" + date + ".png"
    ...
    plt.ylabel('# of Datasets')
    plt.xticks(rotation=25, ha='right')
    graph1 = output + "\datasetProjectCount_" + date + ".png"
    ...
    graph2 = output + "\datasetDivisionCount_" + date + ".png"
    ...
    plt.ylabel('# of Datasets')
    plt.xticks(rotation=25, ha='right', wrap = True)
    graph3 = output + "\datasetDirectorateCount_" + date + ".png"
    plt.savefig(graph3, bbox_inches = "tight")
    plt.show()
    
    # creating dataframe from csv file 
    divisionAdminData = pandas.read_csv(output + '\scienceAdminDivision_' + date + '.csv')
    directorateAdminData = pandas.read_csv(output + '\scienceAdminDirectorate_' + date +'.csv')
    ...
    plt.ylabel('# of Datasets')
    plt.xticks(rotation=25, ha='right', wrap = True)
    graph4 = output + "\ManagementDivisionCount_" + date + '.png'
    ...
    plt.ylabel('# of Datasets')
    plt.xticks(rotation=25, ha='right', wrap = True)
    graph5 = output + "\ScienceDivisionCount_" + date + '.png'
    ...
    plt.ylabel('# of Datasets')
    plt.xticks(rotation=25, ha='right', wrap = True)
    graph6 = output + "ManagementDirectorateCount_" + date + '.png'
    ...
    graph7 = output + "\ScienceDirectorateCount_" + date + '.png'
    ...
    plt.xticks(rotation=25, ha='right', wrap = True)
    graph8 = output + "\DatasetPerYear_" + date + '.png'
